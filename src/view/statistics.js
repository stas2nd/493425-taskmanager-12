...
import {countCompletedTaskInDateRange, countTasksByColor, colorToHex, countTasksInDateRange, parseChartDate, getDatesInRange} from "../utils/statistics.js";
import SmartView from "./smart.js";

const renderColorsChart = (colorsCtx, tasks) => {
  const taskColors = tasks.map((task) => task.color);
  const uniqColors = [...new Set(taskColors)];
...
export default class Statistics extends SmartView {
  ...
  getTemplate() {
    const completedTaskCount = countCompletedTaskInDateRange(this._data.tasks, this._data.dateFrom, this._data.dateTo);
